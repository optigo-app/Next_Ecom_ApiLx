...
import DiamondtineHeader from "@/app/components/(dynamic)/Header/Diamondtine/Header";
...
import Footer from "@/app/components/(static)/Footer/Diamondtine/Footer";
  ...
  return (
    <>
      <Box sx={{ display: "flex", flexDirection: "column", minHeight: "100vh", width: "100%" }}>
         ...
         <DiamondtineHeader hidden={false} logos={logos} storeinit={storeData} />
