    ...
    >
      ...
      >
        ...
        <TextField
          ...
          inputProps={{
            min: 1,
            // Fallback to a safe number, or calculate it directly if totalPages is broken
            max: Number.isNaN(Number(totalPages)) || !totalPages 
              ? Math.ceil(dstCount / itemsPerPage) || 1 
              : totalPages,
            style: {
              textAlign: 'center',
              fontSize: '14px',
