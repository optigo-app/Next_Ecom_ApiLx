...
import MalakanJwewlsHeader from "@/app/components/(dynamic)/Header/MalakanJwewls/Header";
...
import Footer from "@/app/components/(static)/Footer/Malakan/Footer";
  ...
  return (
    <>
      <Box sx={{ display: "flex", flexDirection: "column", minHeight: "100vh", width: "100%" }}>
         ...
         <MalakanJwewlsHeader hidden={false} logos={logos} storeinit={storeData} />
        ...
        <Box sx={{ flex: 1, display: "flex", flexDirection: "column" }}>
          ...
          <Footer storeData={storeData} logos={logos} />
