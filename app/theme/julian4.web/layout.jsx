...
import Heaser from "@/app/components/(dynamic)/Header/julian4/Header"
import FooterNew from "@/app/components/(static)/Footer/Julian4/Footer"
  ...
  return (
    <>
      <Box sx={{ display: "flex", flexDirection: "column", minHeight: "100vh", width: "100%" }}>
       ...
       <Heaser hidden={false} logos={logos} storeInit={storeData} />
