...
const ProductDetailsSection = ({
  ...
  return (
    ...
    >
      {(finalDiaList?.length > 0 || hasMisc || hasColorStone) && (
      ...
      {finalDiaList?.length > 0 && (
        <Box sx={{ mb: 3 }}>
          <DiamondTable list={finalDiaList} details="Diamond Details" />
        </Box>
      )}

      {hasColorStone && (
        <Box sx={{ mb: 3 }}>
          <MiscTable list={finalCsList} details="Color Stone Details" />
        </Box>
      )}

      {hasMisc && (
        <Box sx={{ mb: 3 }}>
          <MiscTable list={finalCsList} details="MISC Details" />
        </Box>
      )}
    </Box>
  );
        ...
        <Table size="small" sx={{ minWidth: { xs: 300, sm: 500 } }}>
          <TableHead>
            <TableRow sx={{ bgcolor: "#f5f5f5" }}>
              <TableCell
                sx={{ fontWeight: 600, color: "#616161", fontSize: "0.875rem" }}
              >
                Shape
              </TableCell>
              <TableCell
