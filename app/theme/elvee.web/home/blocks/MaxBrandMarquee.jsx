...
const MaxBrandMarquee = ({ assetBase }) => {
    ...
    const LOGO_DATA = {
        kayra: ["logo1.png", "logo2.png", "logo3.png", "logo4.png", "logo5.png", "logo6.png"],
    ...
    const ALL_LOGOS = [
        ...LOGO_DATA.kayra.map(l => `${assetBase}/images/HomePage/BrandLogo/kayra/${l}`),
        ...LOGO_DATA.omjiyansh.map(l => `${assetBase}/images/HomePage/BrandLogo/omjiyansh/${l}`),
        ...LOGO_DATA.mayora.map(l => `${assetBase}/images/HomePage/BrandLogo/mayora/${l}`),
        ...LOGO_DATA.sonasons.map(l => `${assetBase}/images/HomePage/BrandLogo/sonasons/${l}`),
    ];
