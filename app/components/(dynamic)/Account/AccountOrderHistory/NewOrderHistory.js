...
const NewOrderHistory = () => {
  ...
  const handleToggleTaxes = (id) => {
    setOpenTaxes(openTaxes === id ? null : id);
  };
  ...
  return (
    <div
      className="orderHistory_Account_SMR"
      style={{
        paddingBottom: "70px",
      }}
    >
                    ...
                    >
                      ...
                      >
                        <div style={{ display: "flex" }}>
                          <div className="pd_s_noh_acc fs_head_acc start_noh_acc  mx_4_noh_acc">
                            {e?.orderEntryDate}
                          </div>
                          <div
                            className="fs_head_acc start_noh_acc  mx_4_noh_acc"
                            style={{ fontWeight: "bold", color: "brown" }}
                          >
                            {e?.OrderPrefix}
                            {e?.orderno}
                          </div>
                          <div className="fs_head_acc start_noh_acc  mx_4_noh_acc">
                            Item :{" "}
                            <span
                          ...
                          <div>
                            {
                              ...
                              >
                                ...
                                >
                                  {formatAmount2(e?.orderAmountwithvat)}
                                </span>
                              </span>
                            }
                            <div
                              className="fs_head_acc_tax start_noh_acc  lh_head_acc mx_4_noh_acc"
                              style={{
                                color: "grey",
                                display: "flex",
                            ...
                            >
                              (
                              <span
                                className="fs_head_acc_tax "
                                style={{ color: "grey", paddingRight: "2px" }}
                              >
                                + Estimated Tax :{" "}
                              </span>{" "}
                              <span
                              ...
                              ></span>{" "}
                              <span className="fs_head_acc_tax ">
                                {formatAmount2(e?.totaltaxAmount)}
                              </span>
                              )
                            </div>
                      ...
                      >
                        {!max400px && (
                          <Box
                            ...
                            className="fs_head_acc minH_box_acc"
                          >
                            <Box
                              sx={{
                                display: "flex",
                              ...
                              className="fs_head_acc w_20_noh_acc"
                            >
                              <Typography
                                style={{
                                  display: "flex",
                                ...
                                className={` ${getStatusColor(e?.b2c_MasterManagement_ProgressStatusId)} fs_head_acc start_noh_acc`}
                              >
                                <CircleIcon
                                  sx={{
                            ...
                            </Box>
                            {
                              <Box
                                ...
                                className="fs_head_acc w_80_noh_acc"
                              >
                                <>
                                  {e?.IsPLW === 1 ? (
                                    <>
                                      ...
                                      >
                                        <div
                                          className={`sidebar ${sidebarOpen && openListStatus === e.id ? "open" : ""}`}
                                          style={{
                                            display: "flex",
                                            flexDirection: "column",
                                          }}
                                        >
                                          ...
                                          >
                                            ...
                                            {e?.IsPLW === 1 && (
                                              <Chip
                                                size="small"
                                                className={`${getStatusColor2(e?.OrderStatusName)} fw-normal fs_head_acc2`}
                                                label={
                                                  e?.OrderStatusName === ""
                                                    ? "Retailer Approval Pending"
                                                    : e?.OrderStatusName
                                                }
                                              />
                                            )}
                                        ...
                                        <MoreVertIcon
                                          className="_color2 p-0"
                                          onClick={() =>
                                            handleToggleActions(e.id)
                                          }
                                        />
                                      </div>
                        ...
                        {max400px && (
                          <Box className="fs_head_acc minH_box_acc">
                            <Box
                              sx={{
                                display: "flex",
                                flexDirection: "column",
                                              ...
                                              {storeInit?.IsPriceShow == 1 && (
                                                ...
                                                >
                                                  <span
                                                    ...
                                                    dangerouslySetInnerHTML={{
                                                      __html:
                                                        e?.Country_CurrencyCode,
                                                    }}
                                                  ></span>
                                                  {formatAmount2(
                                                    el?.TotalUnitCostWithDiscount,
                                                  )}
                                                </div>
                                              )}
                                            </div>
