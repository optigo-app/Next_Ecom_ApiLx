                ...
                <div className='border_Acc'>
                    ...
                    </div>}
                    {
                        (filterArray?.length === 1 && filterArray[0] === 'Data Not Present') ? '' : <>
                            <div className='flex_col_Al' style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                {!isSmallScreen && <div className='fs_al2' style={{ display: 'flex', justifyContent: 'flex-start', alignItems: 'center', flexWrap: 'wrap', marginBottom: '0px', width: '100%', padding: '8px' }}>
                                    ...
                                    <div style={{ paddingBottom: '35px' }}>{filterArray?.length > 0 && <img
                                        src={'/excel.png'} onClick={() => downloadExcelLedgerData()} style={{ height: '40px', width: '40px', objectFit: 'contain', cursor: 'pointer' }} alt='excelExport' title='Download Excel' />}</div>
                                    ...
                                    <Accordion>
                                        ...
                                        <AccordionDetails style={{ padding: '0px' }}>
                                            <Box sx={{ paddingBottom: "10px", paddingRight: "0px" }}>
                                                <Button variant="contained" className="muiSmilingRocksBtn" size='small' sx={{ background: "#7d7f85", display: "flex", alignItems: "center", marginBottom: 0, padding: "6px 10px", width: '100%' }}
                                                    onClick={() => backToInitial3()}>
                                                    All
                                                </Button>
                                            </Box>
                                            <div style={{ display: 'flex', alignItems: 'center', marginTop: '10px', marginBottom: '10px', flexDirection: 'column', width: '100%' }}>
                                                <Box>
                                                    <LocalizationProvider dateAdapter={AdapterDayjs}>
                                                        <DatePicker
                                                            label="Date From"
                                                ...
                                                <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>{filterArray?.length > 0 && <img src={'./excel.png'} onClick={() => downloadExcelLedgerData()} style={{ height: '40px', cursor: 'pointer', width: '40px', objectFit: 'contain', cursor: 'pointer' }} alt='#excelExport' />}</div>
