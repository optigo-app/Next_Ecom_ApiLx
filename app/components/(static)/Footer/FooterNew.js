      ...
      <Box>
        <Grid container spacing={{ xs: 4, md: 6, lg: 8 }}>
          ...
          <Grid item size={{ xs: 12, lg: 3 }}>
            ...
            {loading ? (
              <span className="elv_error_message">Loading...</span>
            ) : (
              <>
                {result && (
                  <span
                    ...
                    style={{
                      color: result.startsWith("Thank You!")
                        ? "#04AF70"
                        : "#FF0000",
                      marginTop: "0px",
                      display: "block",
        ...
        >
          ...
          >
            Copyright &#169; {year} {storeInit?.companyname}. All Rights
            Reserved.
          </Typography>
        </Box>
      </Box>
